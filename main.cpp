...
public:
	...
	static int width() { return MyFrame::WIDTH;  }
	static int height() { return MyFrame::HEIGHT;  }
...
bool MyApp::OnInit()
{
	MyFrame *frame = new MyFrame(_("Program Line Counter"), wxPoint(50, 50),
		wxSize(MyFrame::width() , MyFrame::height() )); 
...
: wxFrame(NULL, -1, title, pos, size)
{
	...
	//ItemListPanel* panel = new ItemListPanel(this);
